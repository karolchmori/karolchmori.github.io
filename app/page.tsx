...
export default function Home() {
  return (
    <main className="p-10">
      <h1 className="text-4xl font-bold mb-8">My Work Experience</h1>
      
      <ProjectCard 
        title="VEX Robotics Research" 
        description="Developing autonomous navigation algorithms." 
      />

      {/* 3. Wrap your post in the provider */}
